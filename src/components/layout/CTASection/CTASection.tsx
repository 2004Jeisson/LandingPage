  ...
  return (
    <section id="buy" className="cta-section">
      ...
      <FadeUp className="cta-content glass-panel">
        ...
        <a href="https://wa.me/573208700771?text=Hola%20somos%20Castrillon%20Conect" target="_blank" rel="noopener noreferrer" className="buy-btn-large">Comprar Ahora — $90.000</a>
      </FadeUp>
    </section>
  );
};
